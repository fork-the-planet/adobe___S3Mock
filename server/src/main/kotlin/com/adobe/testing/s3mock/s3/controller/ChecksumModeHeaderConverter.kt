...
/**
 * Converts values of the [com.adobe.testing.s3mock.common.AwsHttpHeaders.X_AMZ_CHECKSUM_MODE] which is sent by the Amazon
 * client.
...
open class ChecksumModeHeaderConverter : Converter<String, ChecksumMode?> {
  override fun convert(source: String): ChecksumMode? = ChecksumMode.fromValue(source)
}
