...
import com.adobe.testing.s3mock.s3.dto.ErrorResponse
...
class ControllerConfiguration : WebMvcConfigurer {
  ...
  /**
   * Canonical [XmlMapper] builder used by every converter in this configuration — each call
   * returns a new instance with identical settings. Configure the mapper only here — never
   * duplicate the builder chain.
   */
